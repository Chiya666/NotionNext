...
const CONFIG = {
  ...
  STARTER_FEATURE_3_TEXT_1: '人員無法進入的狹小或危險區域，也能有效完成清潔作業。不僅可省去搭設鷹架等作業平台的費用，同時大幅降低人員進入密閉空間所產生的風險，兼顧安全與效率。', // 特性3說明
  ...
  STARTER_FAQ_2_ANSWER:
    '除鏽除漆、管路清潔與疏通、設備與儲槽內外清洗，亦適用於混凝土表面打毛，廣泛應用於各類工業維護與施工作業。',
